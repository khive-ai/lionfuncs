...
def test_to_list_with_mapping():
    ...
    # With use_values=True
    result_values = to_list(d, use_values=True)
...
def test_to_list_with_flatten_tuple_set():
    ...
    result_flatten = to_list(data, flatten=True, flatten_tuple_set=True)
...
def test_to_list_with_dropna():
    ...
    # With dropna=True
    result_dropna = to_list(data, dropna=True)
...
def test_to_list_with_nested_iterables():
    ...
    # With flatten=True
    result_flatten = to_list(data, flatten=True)
