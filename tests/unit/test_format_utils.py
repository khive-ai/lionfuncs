...
class TestFormatUtils:
    ...
    def test_is_in_notebook_in_notebook(self):
        ...
        class MockShell:
            ...
            # __class__ = MockShellClass # Not directly used by the source's logic
            def has_trait(self, trait_name):
                return trait_name == "kernel"
        ...
        with patch("IPython.get_ipython", MockIPython.get_ipython, create=True):
    ...
    def test_is_in_notebook_in_terminal(self):
        ...
        with patch(
            "lionfuncs.format_utils.get_ipython", MockIPython.get_ipython, create=True
        ):
            assert not _is_in_notebook()
