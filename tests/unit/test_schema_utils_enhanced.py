...
class TestSchemaUtilsEnhanced:
    ...
    def test_extract_docstring_parts_with_complex_formatting(self):
        ...
        assert (
            "with default value param3: Simple description without type"
            in params["param2"]
        )
    ...
    def test_pydantic_model_to_openai_schema_with_complex_model(self):
        ...
        assert (
            "anyOf" in schema["properties"]["address"]
    ...
    def test_function_to_openai_schema_with_type_hints_error(self):
        ...
        # Using a string type annotation that doesn't exist
        # noqa: F821 to suppress the undefined name error
        def function_with_forward_ref(a: "UndefinedType") -> bool:  # noqa: F821
