...
def _format_dict_yaml_like(
    ...
    if isinstance(data_dict, dict):
        ...
        for key, value in data_dict.items():
            if isinstance(value, dict):
                ...
                lines.append(_format_dict_yaml_like(
                    value,
        ...
        for item in data_dict:
            ...
            if item_str.startswith(prefix + " "): # if it's already indented (e.g. nested list/dict)
    ...
    if isinstance(data_dict, str):
        # Add quotes if string contains special characters
        if ":" in data_dict or "{" in data_dict or "}" in data_dict or "[" in data_dict or "]" in data_dict:
...
def as_readable(
    ...
    *,
    ...
    if effective_format == "yaml_like":
        ...
        try:
            return json.dumps(processed_data, indent=indent, ensure_ascii=False, default=str)
        except Exception:
            return str(processed_data)
